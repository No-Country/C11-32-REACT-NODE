...
const PricingCard: FC<PricingCardProps> = ({ item }) => {
  const { product, currency, amount = 1, interval, id } = item;
  return (
    <div
      className="
 relative z-10 mb-10 max-w-sm overflow-hidden rounded-xl border border-opacity-20 bg-white px-4 py-10 sm:p-12 lg:px-6 lg:py-10 xl:p-12"
    >
