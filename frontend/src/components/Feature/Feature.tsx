    ...
    <div className="overflow-hidden bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-8 lg:pt-4 relative flex items-center">
            <div className="lg:max-w-lg">
              <h2 className="text-base font-semibold leading-7 text-indigo-600">Improve Your English</h2>
              <p className="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">Practice Conversations</p>
              ...
              <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                <div className="relative pl-9">
                  <dt className="inline font-semibold text-gray-900 mb-2">
                    <AiOutlineTeam className="absolute left-1 top-1 h-6 w-6 text-indigo-600" />
                ...
                <div className="relative pl-9">
                  <dt className="inline font-semibold text-gray-900 mb-2">
                    <AiOutlineComment className="absolute left-1 top-1 h-6 w-6 text-indigo-600" />
                ...
                <div className="relative pl-9">
                  <dt className="inline font-semibold text-gray-900 mb-2">
                    <AiOutlineBulb className="absolute left-1 top-1 h-6 w-6 text-indigo-600" />
          ...
          <div className="relative flex justify-center items-center ">
            <img src={chat} alt="Product screenshot" className="w-500 h-auto my-20" />
          </div>
        </div>
      </div>
    </div>
